...
-- Colors and style
osc_color = "#1e1e2e",                 -- base (dark background)
window_title_color = "#cdd6f4",        -- text (light)
window_controls_color = "#cdd6f4",     -- text (light)
windowcontrols_close_hover = "#f38ba8", -- red (hover close)
windowcontrols_max_hover = "#f9e2af",  -- yellow (hover maximize)
windowcontrols_min_hover = "#a6e3a1",  -- green (hover minimize)
title_color = "#cdd6f4",               -- text
cache_info_color = "#bac2de",          -- subtext1
seekbarfg_color = "#fab387",           -- peach (seekbar progress)
seekbarbg_color = "#45475a",           -- surface1 (remaining seekbar)
seekbar_cache_color = "#585b70",       -- surface2 (cache ranges)
volumebar_match_seek_color = false,    -- keep original
time_color = "#cdd6f4",                -- text
chapter_title_color = "#cdd6f4",       -- text
side_buttons_color = "#cdd6f4",        -- text
middle_buttons_color = "#cdd6f4",      -- text
playpause_color = "#cdd6f4",           -- text
held_element_color = "#9399b2",        -- overlay2 (pressed)
hover_effect_color = "#fab387",        -- peach (hover)
thumbnail_border_color = "#11111b",    -- crust (dark border)
thumbnail_border_outline = "#313244",  -- surface0 (border outline)
